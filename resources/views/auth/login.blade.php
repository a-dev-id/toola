...
<body>
    ...
    <section>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xl-7">
                    <img class="bg-img-cover bg-center" src="{{asset('vendors/viho')}}/assets/images/login/2.jpg" alt="looginpage" />
                </div>
                        ...
                        <form class="theme-form login-form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" type="email" required placeholder="john@doe.com" name="email" value="{{old('email')}}" />
                                </div>
                            </div>
                            <div class="form-group">
